...
$resultx = mysql_query($queryx) or die("Query failedx.");
while ($line = mysql_fetch_array($resultx)) {
?>
...
?>
    ...
    <!--<input type="radio" id="url1" name="url" value="1" checked="checked" onClick="return uploadfile('url1');" />From PC&nbsp;&nbsp;-->
...
<link rel="stylesheet" href="./d24w6bsrhbeh9d.cloudfront.net/css/screen-v5.4.3.css" media="screen,projection" type="text/css" />
...
<script type="text/javascript" src="./d24w6bsrhbeh9d.cloudfront.net/js/gag.min-v2.6.3.js"></script>
				...
				<ul class="main-menu" style="overflow:visible">
					<li><a class="" href="./hot">笑料</a></li>
						...
						<div id="profile-menu" class="profile-menu">
													...
													<ul>
																<li><a href="./https@9gag.com/settings">控制面板</a></li>
...
<script type="text/javascript">
//<![CDATA[
window.title_filters = ["faggot","pervert","nigger",".//com",".//net",".//info","http","title","likethisif","votethis","likeif","voteif","amithe","llgetthis","llgetit","shouldgetit","shouldgetthis","llunderstand","llknowit","dildo","jailbait","9fag","9fap","9gagarmy","9gagtroop","9gagsolider","voter","votepage","trending","firstpost"];
...
-->
    <form class="modal" name="newupload" id="newupload" method="post"
		...
		<div class="field">
			<label>
				<h4>Pic File</h4>
				<input id="photo_file_upload" class="file text " type="file" name="thefile0" accept="image/gif,image/jpeg,image/jpg,image/png" style="display:;"></input>
				<input id="photo_post_url" type="text" class="text " name="url" value="" style="display:none;"></input>
			</label>
			<p class="info">
								<input type="hidden" name="file" value="1"/>
				<a class="post_link" href="submit_url.php"><strong>貼上圖片網址。</strong></a>
	...
	<div class="field">
		...
		<!--<input id="submit1" name="submit" value="Upload" type="image" src="imagesharing/i/upload.jpg" title="Upload selected photos" alt="upload" />-->
