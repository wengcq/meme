...
target="formsubmit"
-->
<form class="modal" name="newupload" id="newupload1" method="post"
	...
	onSubmit="return show_loading1();">
		...
		<div class="field">
			<label>
				<h4>Pic File</h4>
				<!--nemo: thefile0-->
				<input type="text" class="text " size="50" name="thefile0" />
			...
			<p class="info">
				...
				<a class="post_link" href="submit_photo.php"><strong>貼上圖片網址。</strong></a>
